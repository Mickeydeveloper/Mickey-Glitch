...
exports.safeSendMessage = async (sock, chatId, message, options = {}, timeout = 30000) => {
    return new Promise((resolve, reject) => {
        try {
            if (!sock || !sock.originalSendMessage) {
                return reject(new Error('Socket or originalSendMessage not available'))
            }
            ...
            // Race against timeout - ONLY call originalSendMessage, NEVER sock.sendMessage
            Promise.race([
                sock.originalSendMessage(chatId, message, options),
                timeoutPromise
