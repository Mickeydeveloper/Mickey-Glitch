...
const aliveCommand = async (sock, chatId, message) => {
    ...
    try {
        ...
        // Interactive message title with gradient effect
        const title = `╔═══════❖•ೋ° 📡 °ೋ•❖═══════╗
...
┃ ✦ 𝐔𝐒𝐄𝐑 𝐈𝐍𝐅𝐎 ✦
┣━━━━━━━━━━━━━━━━━━━━┛
┃ 👤 𝐍𝐚𝐦𝐞: ${message.pushName || '𝐆𝐮𝐞𝐬𝐭'}
┃ 🆔 𝐓𝐚𝐠: @${message.key.participant?.split('@')[0] || chatId.split('@')[0]}
┃ 📅 𝐃𝐚𝐭𝐞: ${formattedDate}
┃ 🕐 𝐓𝐢𝐦𝐞: ${time} 𝐄𝐀𝐓
┃ 🚀 𝐏𝐢𝐧𝐠: ${pingEmoji} ${latency}𝐦𝐬
┗━━━━━━━━━━━━━━━━━━━━━
...
┃ 💾 𝐑𝐀𝐌: ${usedRam.toFixed(2)}/ ${totalRam.toFixed(0)}𝐆𝐁
┃ 📊 ${ramBar} ${ramPercent}%
┃ 🖥️ 𝐂𝐏𝐔: ${cpuModel.split(' ').slice(0, 2).join(' ')}
┃ 🔢 𝐂𝐨𝐫𝐞𝐬: ${cpuCores}
┃ 📈 𝐋𝐨𝐚𝐝: ${cpuLoad['1m']}% | ${cpuLoad['5m']}% | ${cpuLoad['15m']}%
┗━━━━━━━━━━━━━━━━━━━━━
...
┃ 💻 𝐀𝐫𝐜𝐡: ${arch}
┃ 🟢 𝐍𝐨𝐝𝐞: 𝐯${nodeVersion}
┃ 🌍 𝐈𝐏: ${network.ipAddress}
┃ 🔌 𝐌𝐀𝐂: ${network.macAddress}
┗━━━━━━━━━━━━━━━━━━━━━

╔━━━━━━━━━━━━━━━━━━━━╗
┃ ✨ 𝐒𝐘𝐒𝐓𝐄𝐌 𝐇𝐄𝐀𝐋𝐓𝐇 ✨
╚━━━━━━━━━━━━━━━━━━━━╝
${ramPercent < 70 ? '✅ 𝐒𝐭𝐚𝐭𝐮𝐬: 𝐏𝐞𝐫𝐟𝐞𝐜𝐭 🟢' : ramPercent < 85 ? '⚠️ 𝐒𝐭𝐚𝐭𝐮𝐬: 𝐒𝐭𝐚𝐛𝐥𝐞 🟡' : '❌ 𝐒𝐭𝐚𝐭𝐮𝐬: 𝐇𝐞𝐚𝐯𝐲 🔴'}
🎯 𝐏𝐞𝐫𝐟𝐨𝐫𝐦𝐚𝐧𝐜𝐞: ${latency < 100 ? '𝐄𝐱𝐜𝐞𝐥𝐥𝐞𝐧𝐭' : latency < 200 ? '𝐆𝐨𝐨𝐝' : '𝐒𝐥𝐨𝐰'}
💡 𝐅𝐫𝐞𝐞 𝐑𝐀𝐌: ${freeRam.toFixed(2)}𝐆𝐁
