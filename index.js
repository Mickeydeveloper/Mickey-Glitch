        ...
        if (connection == "open") {
            ...
            try {
                ...
                await XeonBotInc.sendMessage(botNumber, {
                    text: `✨ 𝙼𝚒𝚌𝚔𝚎𝚢 𝙶𝚕𝚒𝚝𝚌𝚑™ is online and ready.\n\n🕒 Connected: ${new Date().toLocaleString()}\n🔋 Status: Active — available to serve commands\n\n🔍 Need help? Send: .help\n🔗 Channel: (join link or channel id)`
                });
            } catch (error) {
            ...
            console.log(chalk.yellow(`\n\n                  ${chalk.bold.blue(`[ ${global.botname || '𝙼𝚒𝚌𝚔𝚎𝚢 𝙶𝚕𝚒𝚝𝚌𝚑™'} ]`)}\n\n`))
